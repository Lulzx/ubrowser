...
import {
  navigateTool, executeNavigate,
  clickTool, executeClick,
  typeTool, executeType,
  selectTool, executeSelect,
  scrollTool, executeScroll,
  snapshotTool, executeSnapshot,
...
server.tool(
  ...
  async (args) => {
    const result = await executeClick(args as any);
    return {
      content: [{ type: 'text', text: JSON.stringify(result) }],
    };
  }
...
server.tool(
  ...
  async (args) => {
    const result = await executeType(args as any);
    return {
      content: [{ type: 'text', text: JSON.stringify(result) }],
    };
  }
...
server.tool(
  ...
  async (args) => {
    const result = await executeSelect(args as any);
    return {
      content: [{ type: 'text', text: JSON.stringify(result) }],
    };
  }
